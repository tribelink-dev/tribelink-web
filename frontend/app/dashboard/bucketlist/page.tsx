...
export default function BucketlistPage() {
  ...
  return (
    <PageContainer className="pb-8">
      <h1 className="text-2xl font-semibold text-text-primary mb-2">Bucketlist</h1>
      <p className="text-sm text-text-secondary mb-8">Homestays and experiences on your bucketlist</p>

      {isEmpty ? (
        <div className="text-center py-16">
          <Heart className="w-12 h-12 text-text-secondary opacity-40 mx-auto mb-4" />
          <p className="text-text-secondary mb-4">Your bucketlist is empty</p>
