          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="heading-secondary text-gray-900 mb-2">
                Welcome back, {host?.name || 'Experience Host'}!
              </h1>
              <p className="text-gray-600">
                {getProviderWelcomeMessage('EXPERIENCE_HOST')}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="card-professional card-hover p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="heading-tertiary mb-0">Add Experience</h3>
            </div>
            <p className="text-gray-600 mb-4">Create a new experience listing</p>
            <button 
          ...
          <div className="card-professional card-hover p-6">
            ...
            <p className="text-gray-600 mb-4">View customer reviews</p>
            <button className="btn-secondary w-full">
              View Reviews
            </button>
          </div>
