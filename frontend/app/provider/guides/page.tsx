          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-gray-600">
                {getProviderWelcomeMessage('GUIDE')}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="card-professional card-hover p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="heading-tertiary mb-0">My Tours</h3>
            </div>
            <p className="text-gray-600 mb-4">View and manage your guided tours</p>
          ...
          <div className="card-professional card-hover p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="heading-tertiary mb-0">Create Tour</h3>
            </div>
            <p className="text-gray-600 mb-4">Add a new guided tour</p>
            <button className="btn-primary w-full">
              Create Tour
            </button>
          </div>
          ...
          <div className="card-professional card-hover p-6">
            ...
            <p className="text-gray-600 mb-4">Set your tour availability</p>
          ...
          <div className="card-professional card-hover p-6">
            ...
            <p className="text-gray-600 mb-4">Manage tour bookings</p>
            <button className="btn-secondary w-full">
              View Bookings
            </button>
          </div>
          ...
          <div className="card-professional card-hover p-6">
            ...
            <p className="text-gray-600 mb-4">View traveler reviews</p>
            <button className="btn-secondary w-full">
              View Reviews
            </button>
          </div>
