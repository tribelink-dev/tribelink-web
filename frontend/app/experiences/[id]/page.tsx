...
export default function ExperienceDetailPage() {
    ...
    return (
      ...
      <div className="min-h-screen bg-background pt-below-nav pb-16">
        ...
        <PageContainer>
          ...
          <Button variant="secondary" className="mt-4" onClick={() => router.push('/explore?section=experiences')}>
  ...
  const location = experience.location
    ...
    ? [experience.location.district, experience.location.state].filter(Boolean).join(', ')
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div>
              ...
              <h1 className="text-2xl md:text-3xl font-semibold text-text-primary mb-2">{experience.title}</h1>
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed whitespace-pre-line">{experience.description}</p>
            ...
            {experience.provider && (
              ...
              <Card className="p-6">
                ...
                {experience.provider.rating > 0 && (
                  ...
                  <p className="text-sm text-text-secondary mt-1">Host rating {experience.provider.rating.toFixed(1)}</p>
