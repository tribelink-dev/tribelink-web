  ...
  return (
    <>
      ...
      <AnimatePresence>
        {stickySearchVisible && (
          <motion.div
            key="explore-sticky-search"
            initial={{ opacity: 0, y: -8 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -8 }}
            transition={{ duration: 0.2, ease: 'easeOut' }}
            className="fixed top-below-nav-explore lg:top-below-nav left-0 right-0 z-40 px-page lg:px-page-lg"
            data-analytics="explore-search-sticky"
          >
            <div className="w-full max-w-3xl mx-auto py-2 lg:pt-3 lg:pb-2">
