          ...
          <div className="px-8 py-8 bg-white">
            ...
            <div className="mt-8 space-y-3 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/signup" className="font-bold text-heritage-gold hover:text-heritage-gold-dark transition-colors">
                  Create one now
                </Link>
              </p>
              <p className="text-sm text-gray-500">
                Are you a host?{' '}
                <Link href="/host/login" className="font-semibold text-heritage-gold hover:text-heritage-gold-dark transition-colors">
                  Sign in as host
                </Link>
              </p>
            </div>
