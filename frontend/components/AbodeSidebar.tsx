  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-[calc(1rem+env(safe-area-inset-top,0px))] left-4 z-40 touch-target p-3 bg-white rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-all"
      >
